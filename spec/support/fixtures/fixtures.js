...
var Fixtures = {
  ...
  restoreFixtures : function() {
    ...
    this.user.set({id: 342, username: 'testuser', password: 'testuser', email: 'testuser@example.com', first_name: 'Test', last_name: 'User'});
    this.task1.set({id: 1, owner_id: 342, title: 'Task 1', status: 'New', priority: 'Low', position: 1});
    this.task2.set({id: 2, owner_id: 342, title: 'Task 2', status: 'New', priority: 'Normal', position: 2});
    this.task3.set({id: 3, owner_id: 342, title: 'Task 3', status: 'Complete', priority: 'Normal', position: 3});
    this.collection.reset([that.task1, that.task2, that.task3]);
  }
}
