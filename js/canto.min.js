...
require("../../dependencies.js");var View=require("../modelViews/taskViews/taskListItemView.js"),Task=require("../../models/taskModel.js"),task=new Task({id:1,title:"Make tests for the SpecWrapper views"}),SpecWrapper=Backbone.View.extend({el:"body",template:JST["spec/listItem"],events:{"click a":"callMethod"},callMethod:function(e){e.preventDefault(),eval(this.view[$(e.target).attr("data-method")])},initialize:function(){this.view=new View({model:task})},render:function(){this.$el.html(this.template()),this.view.render(),this.$("#view").html(this.view.el)}});module.exports=SpecWrapper;
