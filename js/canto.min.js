...
},{"../collections/taskCollection.js":5,"../dependencies.js":6,"buffer":21}],10:[function(require,module,exports){
...
var taskModel=require("../../js/models/taskModel.js"),taskListItemView=require("../../js/views/modelViews/taskViews/taskListItemView.js"),TestRouter=Backbone.Router.extend({routes:{"listItemViewSpec(/)":"displayListItemView"},displayListItemView:function(){var e={id:1,title:"Troubleshoot Selenium tests"},t=new taskModel(e),s=new taskListItemView({model:t});s.render(),$("body").html(s.$el)}});module.exports=TestRouter;
},{"../../js/models/taskModel.js":8,"../../js/views/modelViews/taskViews/taskListItemView.js":11}],18:[function(require,module,exports){
