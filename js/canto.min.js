...
Canto=Canto||require("../../dependencies.js"),Backbone.View.prototype.klass="Backbone.View",Backbone.View.prototype.types=function(){return["Backbone.View"]},Backbone.View.prototype.isA=function(e){return this.types.indexOf(e)>-1?!0:!1},Canto.View=Backbone.View.extend({klass:"CantoView",family:"Backbone.View",superFamily:"",types:function(){return Backbone.View.prototype.types().concat(["Canto.View"])},isA:function(e){return this.types().indexOf(e)>-1?!0:!1}}),module.exports=Canto.View;
},{"../../dependencies.js":6}],13:[function(require,module,exports){
Canto=Canto||require("../../dependencies.js"),Canto.View=Canto.View||require("./cantoView.js");var UserModel=require("../../models/userModel.js"),SidebarView=require("../partialViews/dashboardSidebarView.js"),DashboardView=Canto.View.extend({id:"dashboard-wrapper",template:JST.dashboard,events:{click:"hideDropdownMenus","click li.dropdown":"toggleDropdownMenu"},klass:"DashboardView",family:"Canto.View",superFamily:"Dashboard.View",hideDropdownMenus:function(e){var i=this.$("li.dropdown");i.is(e.target)||i.has(e.target).length||i.removeClass("open")},toggleDropdownMenu:function(e){var i=$(e.target).closest("li.dropdown");i.siblings().removeClass("open"),i.toggleClass("open")},setUser:function(e){this.user=e},showHomeView:function(){this.$el.is(":visible")||this.render()},showTaskView:function(){this.$el.is(":visible")||this.render()},initialize:function(e){e=e||{},this.setUser(e.user),this.sidebarView=new SidebarView},remove:function(){this.sidebarView.remove(),Backbone.View.prototype.remove.call(this)},render:function(){return this.$el.html(this.template({user:this.user})),this.delegateEvents(),this.sidebarView.render(),this.$("div.sidebar-collapse").html(this.sidebarView.el),this}});module.exports=DashboardView;
...
Canto=Canto||require("../../dependencies.js"),Canto.View=Canto.View||require("../appViews/cantoView.js");var QuickAddForm=require("../modelViews/taskViews/quickAddFormView.js"),ListItemView=require("../modelViews/taskViews/taskListItemView.js"),TaskCollectionView=Canto.View.extend({tagName:"ul",className:"task-list",template:JST["collections/task"],klass:"TaskCollectionView",family:"Canto.View",superFamily:"Backbone.View",types:function(){return Canto.View.prototype.types().concat(["TaskCollectionView","TaskView"])},renderCollection:function(){var e=this;this.collection.each(function(i){var t=e.retrieveViewForModel(i)||new ListItemView({model:i});e.childViews.indexOf(t)<=-1&&e.childViews.push(t),t.render(),e.$el.append(t.$el)})},retrieveViewForModel:function(e){if(!this.childViews.length)return null;var i=_.filter(this.childViews,function(i){return i.model===e});return i[0]},initialize:function(e){e=e||{},this.grouping=e.grouping,this.childViews=[],this.quickAddForm=new QuickAddForm({collection:this.collection,grouping:this.grouping})},render:function(){return this.$el.html(this.template()),this.quickAddForm.render(),this.$("li.quick-add-form").html(this.quickAddForm.$el),this.renderCollection(),this.delegateEvents(),this}});module.exports=TaskCollectionView;
...
Canto=Canto||require("../../../dependencies.js"),CantoView=Canto.View||require("../../appViews/cantoView.js");var TaskModel=require("../../../models/taskModel.js"),TaskModelView=CantoView.extend({tagName:"div",className:"task-model",template:JST["tasks/model"],klass:"TaskModelView",family:"Canto.View",superFamily:"Backbone.View",types:function(){return Canto.View.prototype.types().concat("TaskModelView")},renderOnSync:function(){"Complete"!==this.model.get("status")&&this.render()},initialize:function(){this.listenTo(this.model,"sync",this.renderOnSync)},render:function(){return this.$el.html(this.template({model:this.model})),this}});module.exports=TaskModelView;
},{"../../../dependencies.js":6,"../../../models/taskModel.js":8,"../../appViews/cantoView.js":12}],18:[function(require,module,exports){
Canto=Canto||require("../../dependencies.js");var DashboardSidebarView=Backbone.View.extend({tagName:"ul",className:"nav",id:"side-menu",template:JST["partials/sidebar"],events:{"click a.sidebar-link":"toggleSecondLevelNav","click li > .dashboard-link":"goToDashboard","click li > .task-page-link":"goToTaskPage"},goToDashboard:function(){this.trigger("redirect",{destination:"dashboard"})},goToTaskPage:function(){this.trigger("redirect",{destination:"tasks"})},toggleSecondLevelNav:function(e){var a=$(e.target).closest("li");a.hasClass("active")?a.removeClass("active").find(".nav-second-level").slideUp():(a.siblings("li").removeClass("active"),this.$(".nav-second-level:visible").slideUp(),a.addClass("active").find(".nav-second-level").slideDown()),""===a.className&&a.removeAttr("class")},getLocationHash:function(){return location.hash},isA:function(e){var a=["Backbone.View","DashboardSidebarView","DashboardView","PartialView"];return a.indexOf(e)>-1},render:function(){return this.$el.html(this.template()),this.delegateEvents(),this}});module.exports=DashboardSidebarView;
},{"../../dependencies.js":6}],19:[function(require,module,exports){
Canto=Canto||require("../../dependencies.js");var CollectionView=require("../collectionViews/taskCollectionView.js"),TaskPanelView=Backbone.View.extend({});module.exports=TaskPanelView;
},{"../../dependencies.js":6,"../collectionViews/taskCollectionView.js":14}],20:[function(require,module,exports){
