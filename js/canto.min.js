...
Canto=Canto||require("../../dependencies.js"),Canto.View=Canto.View||require("../appViews/cantoView.js");var User=require("../../models/userModel.js"),TopWidgetView=require("./dashboardTopWidgetView.js"),TaskPanelView=require("./taskPanelView.js"),DashboardHomeView=Canto.View.extend({template:JST["partials/dashHome"],klass:"DashboardHomeView",family:"Canto.View",superFamily:"Backbone.View",types:function(){return Canto.View.prototype.types().concat(["DashboardHomeView","PartialView"])},createTopWidgets:function(){var e=this;this.topWidgetView=new TopWidgetView({taskCollection:e.user.tasks,deadlineCount:2,appointmentCount:4,recommendationCount:11})},setUser:function(e){this.user=e,this.collection=this.user.tasks,this.taskPanelView=new TaskPanelView({collection:this.collection}),this.createTopWidgets()},initialize:function(e){e=e||{},e.user&&this.setUser(e.user)},render:function(){var e=this;return Canto.View.prototype.render.call(this,this.template(),function(){e.taskPanelView.render(),e.$("div.col-lg-6").first().html(e.taskPanelView.$el),e.topWidgetView.render(),$.contains(e.$el,e.topWidgetView.$el)&&e.topWidgetView.remove(),e.$el.prepend(e.topWidgetView.$el)})}});module.exports=DashboardHomeView;
