...
},{"../templates/jst.js":37,"../vendor/jquery-ui-1.11.4.custom/jquery-ui.min.js":55,"./api.js":1,"./utils.js":12,"backbone":31,"jquery":33,"jquery.cookie":32,"underscore":34}],7:[function(require,module,exports){
...
},{"../collections/taskCollection.js":5,"../dependencies.js":6,"./cantoModel.js":7,"buffer":56}],11:[function(require,module,exports){
...
Canto=Canto||require("../../dependencies.js"),Canto.View=Canto.View||require("./cantoView.js");var userModel=require("../../models/userModel.js"),SidebarView=require("../partialViews/dashboardSidebarView.js"),HomeView=require("../partialViews/dashboardHomeView.js"),DashboardView=Canto.View.extend({id:"dashboard-wrapper",template:JST.dashboard,klass:"DashboardView",family:"Canto.View",superFamily:"Backbone.View",types:function(){return Canto.View.prototype.types().concat(["DashboardView","MainDashboardView","Dashboard","MainDashboard","TopLevelView"])},events:{click:"hideDropdownMenus","click li.dropdown":"toggleDropdownMenu"},hideDropdownMenus:function(e){var i=this.$("li.dropdown");i.is(e.target)||i.has(e.target).length||i.removeClass("open")},toggleDropdownMenu:function(e){var i=$(e.target).closest("li.dropdown");i.siblings().removeClass("open"),i.toggleClass("open")},setUser:function(e){this.user=e,this.homeView.setUser(e)},showHomeView:function(){this.$el.is(":visible")||this.render(),this.homeView.render(),this.$("nav").after(this.homeView.$el)},showTaskView:function(){this.$el.is(":visible")||this.render(),this.homeView.$el.is(":visible")&&this.homeView.remove()},initialize:function(e){e=e||{},this.sidebarView=new SidebarView,this.homeView=new HomeView,e.user&&this.setUser(e.user)},remove:function(){this.sidebarView.remove(),Backbone.View.prototype.remove.call(this),this.homeView.remove()},render:function(){var e=this;return Canto.View.prototype.render.call(this,this.template({user:this.user}),function(){e.sidebarView.render(),e.$("div.sidebar-collapse").html(e.sidebarView.$el)})}});module.exports=DashboardView;
},{"../../dependencies.js":6,"../../models/userModel.js":10,"../partialViews/dashboardHomeView.js":19,"../partialViews/dashboardSidebarView.js":20,"./cantoView.js":13}],15:[function(require,module,exports){
