...
require("../../dependencies.js");var Sidebar=require("../partialViews/dashboardSidebarView.js"),SpecWrapper=Backbone.View.extend({el:"body",template:JST["spec/sidebar"],events:{"click a[data-method=toggleSecondLevelNav]":"callToggleSecondLevelNav","click a[data-method=showLastNav]":"showLastNav"},callToggleSecondLevelNav:function(e){e.preventDefault();var t=this,i=$.Event("click",{target:t.view.$('a[href=#]:contains("UI Elements")').first()});this.view.toggleSecondLevelNav(i)},showLastNav:function(e){e.preventDefault();var t=this,i=$.Event("click",{target:t.view.$("a[href=#]").last()});this.view.$('a[href="blank.html"]').is(":visible")||this.view.toggleSecondLevelNav(i)},initialize:function(){this.view=new Sidebar},render:function(){this.$el.html(this.template()),this.view.render(),this.$("#view").html(this.view.$el),this.view.delegateEvents()}});module.exports=SpecWrapper;
