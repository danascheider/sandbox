...
},{"../templates/jst.js":31,"../vendor/jquery-ui-1.11.4.custom/jquery-ui.min.js":42,"./api.js":1,"./utils.js":12,"backbone":26,"jquery":28,"jquery.cookie":27,"underscore":29}],7:[function(require,module,exports){
...
},{"../collections/taskCollection.js":5,"../dependencies.js":6,"./cantoModel.js":7,"buffer":43}],11:[function(require,module,exports){
...
Canto=Canto||require("../../dependencies.js"),Canto.View=Canto.View||require("../appViews/cantoView.js");var CollectionView=require("../collectionViews/taskCollectionView.js"),TaskPanelView=Canto.View.extend({});module.exports=TaskPanelView;
...
Canto=Canto||require("../../dependencies.js");var TaskModel=require("../../models/taskModel.js"),Collection=require("../../collections/taskCollection.js");TaskPanel=require("../partialViews/taskPanelView.js");var task1=new TaskModel({id:1,title:"Task 1",status:"New",priority:"Normal",position:1}),task2=new TaskModel({id:2,title:"Task 2",status:"New",priority:"Normal",position:2}),task3=new TaskModel({id:3,title:"Task 3",status:"Complete",priority:"Normal",position:3}),collection=new Collection([task1,task2,task3]),SpecWrapper=Backbone.View.extend({el:"body",template:JST["spec/taskPanel"],initialize:function(){this.view=new TaskPanel({collection:collection}),this.render()},render:function(){return this.$el.html(this.template()),this.delegateEvents(),this.view.render(),this.$("#view").html(this.view.$el),this.view.delegateEvents(),this}});module.exports=SpecWrapper;
},{"../../collections/taskCollection.js":5,"../../dependencies.js":6,"../../models/taskModel.js":9,"../partialViews/taskPanelView.js":20}],26:[function(require,module,exports){
...
},{"../../js/dependencies.js":6,"../../js/views/specViews/dashboardSidebarSpecView.js":21,"../../js/views/specViews/dashboardSpecView.js":22,"../../js/views/specViews/taskCollectionSpecView.js":23,"../../js/views/specViews/taskListItemSpecView.js":24,"../../js/views/specViews/taskPanelSpecView.js":25}],31:[function(require,module,exports){
...
},{"./modelTemplates/taskTemplates/listItemTemplate.js":32,"./modelTemplates/taskTemplates/modelTemplate.js":33,"./modelTemplates/taskTemplates/quickAddFormTemplate.js":34,"./partialTemplates/dashboardSidebarTemplate.js":35,"./specTemplates/dashboardSidebarSpecTemplate.js":36,"./specTemplates/dashboardSpecTemplate.js":37,"./specTemplates/taskCollectionSpecTemplate.js":38,"./specTemplates/taskListItemSpecTemplate.js":39,"./specTemplates/taskPanelSpecTemplate.js":40,"./topLevelTemplates/dashboardTemplate.js":41,"underscore":29}],32:[function(require,module,exports){
