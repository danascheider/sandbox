...
Canto=Canto||require("../../dependencies.js"),Canto.View=Canto.View||require("./cantoView.js");var UserModel=require("../../models/userModel.js"),SidebarView=require("../partialViews/dashboardSidebarView.js"),DashboardView=Canto.View.extend({id:"dashboard-wrapper",template:JST.dashboard,klass:"DashboardView",family:"Canto.View",superFamily:"Backbone.View",types:function(){return Canto.View.prototype.types().concat(["DashboardView","TopLevelView"])},events:{click:"hideDropdownMenus","click li.dropdown":"toggleDropdownMenu"},hideDropdownMenus:function(e){var i=this.$("li.dropdown");i.is(e.target)||i.has(e.target).length||i.removeClass("open")},toggleDropdownMenu:function(e){var i=$(e.target).closest("li.dropdown");i.siblings().removeClass("open"),i.toggleClass("open")},setUser:function(e){this.user=e},showHomeView:function(){this.$el.is(":visible")||this.render()},showTaskView:function(){this.$el.is(":visible")||this.render()},initialize:function(e){e=e||{},this.setUser(e.user),this.sidebarView=new SidebarView},remove:function(){this.sidebarView.remove(),Backbone.View.prototype.remove.call(this)},render:function(){var e=this;return Canto.View.prototype.render.call(this,this.template({user:this.user}),function(){e.sidebarView.render(),e.$("div.sidebar-collapse").html(e.sidebarView.$el)})}});module.exports=DashboardView;
