...
require("../../dependencies.js");var UserModel=require("../../models/userModel.js"),DashboardView=Backbone.View.extend({id:"dashboard-wrapper",template:JST.dashboard,setUser:function(e){this.user=e},initialize:function(e){e=e||{},this.setUser(e.user)},render:function(){this.$el.html(this.template({user:this.user})),this.delegateEvents()}});module.exports=DashboardView;
